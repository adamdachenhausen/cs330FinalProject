...
32
How long would you like it to take in seconds, to read/write to the cache?
0
How long would you like it to take in seconds, to read/write to the RAM?
5
Finally, how long would you like it to take in seconds, to read/write to a HDD?
10
...
According to Eric Shanks from ithollow.com, the following were the Hard Drive Rotational latencies in 2013.
...
and Improving the Latency of D-RAM based Memory Systems', in the period of 1999 - 2017, the capacity of
RAM has increased a gigantic 128 times, where as the Bandwidth of a RAM has increased a good enough 20 times,
however the improvenement in latency haa only a factor of 1.3x. We can safely assume that the latency of a RAM
has been consistent compared to the latency of Hard Drive over time or the CPU.
...
and at the high level.(Source: gist/github.com/jboner/2841832)
...
research.ece.cmu.edu/safari/thesis/kchang_dissertation.pdf
people.cs.pitt.edu/~cho/cs1541/current/handouts/lect-memh_4up.pdf
